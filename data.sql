...
insert into products (id, productName, price, minBuy, productImages, models_id, category_id) values 
 ...
 (5, 'Escritorio para pc Su-Office Fan melamina de 163cm x 75cm x 60cm x 140cm blanco y negro', 98424, 10, 'escritorioOficina.webp', 7, 4),
 (6, 'Cajonera 4 Cajones / Escritorio / Oficina Con Ruedas', 30324, 5, 'cajonera.webp', 5, 4),
 (7, 'Impresora a color multifunción Epson EcoTank L3210 negra 220V', 150124, 5, 'impresora.jpg', 2, 5),
 (8, 'Impresora simple función Xerox Phaser 3020/BI con wifi blanca y azul 220V - 240V', 13255, 5, 'impresoraXerox.jpg', 3, 5),
 (9, 'Apple Macbook Air', 300524, 2, 'macbook1.webp', 2, 5), 
 (10, 'Monitor LG 24MK430H led 23.8 negro 100V/240V', 150909, 10, 'monitorLg.jpeg', 3, 5),
 (11, 'Delantal de cocina Universal', 5200, 30, 'delantalCocina.jpg', 5, 6),
 (12, 'Remera Clásica Manga Corta Blanca', 4000, 10, 'remeraLisa.jpg', 2, 6),
 (13, 'Resma A4 Papel Autor 75grs 500 Hojas', 2500, 4, 'cajaHojasA4.jpg', 5, 3),
 (14, 'Casaca De Cocina Unisex Edulchef Mangas Cortas', 66883, 5, 'uniformeCocina.jpg', 3, 6);
