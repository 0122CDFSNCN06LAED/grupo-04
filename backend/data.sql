...
insert into products (id, productName, price, minBuy, productImages, description, models_id, category_id,vendor_id) values 
 ...
 (15, 'MacBook Air A1466 plata 13.3"', 310524, 2, 'macbookPlateada.webp','La notebook Apple MacBook Air A1466 es una solución tanto para trabajar y estudiar como para entretenerte. Al ser portátil, el escritorio dejará de ser tu único espacio de uso para abrirte las puertas a otros ambientes ya sea en tu casa o en la oficina.', 14, 5, 1),
 (16, 'Terraja 4 Funciones Para Gomeria', 999, 10, 'terraja.webp','HERRAMIENTA MULTIFUNCIÓN: TERRAJA - MACHO DE ROSCA Y EXTRACTOR OVULO INTERIOR VALVULA SCHRADER / PICO TIPO AUTO MATERIAL : ACERO PESO: 18 GRAMOS', 14, 2, 1),
 (17, 'Crique Hidráulico', 45500, 10, 'crique.webp','Información Técnica: Carga máxima soportada: 10 Toneladas. Altura de construcción: 200 mm Dimensión de la base de apoyo: 122x115 mm Carrera de elevación hidráulica: 125 mm Altura de husillo: 60 mm Altura total: 385 mm Peso total: 5,5 Kg', 14, 2, 1),
 (18, 'Chocolinas ', 1200, 15, 'chocolinas.webp','Son las mejores, probalas', 14, 1, 1),
 (19, 'Toallitas húmedas Huggies Triple Protección 48 u', 2500, 20, 'toallitasHumedas.webp','Es libre de alcohol: Sí Es hipoalergénica: Sí', 14, 1, 1),
 (20, 'Silla de escritorio', 50000, 10, 'sillaEscritorioo.webp','La selección de una silla adecuada es muy importante para prevenir futuras lesiones. Con esta silla Rastasabalero sillas, vas a tener la comodidad y el bienestar que necesitás a lo largo de tu jornada. Además, podés ubicarla en cualquier parte de tu casa u oficina ya que su diseño se adapta a múltiples entornos. ¡Dale a tus espacios un toque más moderno!', 14, 4, 1),
 (21, 'Silla de escritorio Good Game Pro', 124550, 3, 'sillaGAmer.webp','Jugá sin límites Diseñada para quienes pasan muchas horas frente a la computadora. El asiento y el respaldo se adaptan a tus diferentes posiciones a lo largo del juego. Disfrutá sin descuidar las zonas lumbar, dorsal y cervical.', 14, 4, 1),
 (22, 'Lapiz Lapices Filgo Color Caja X 12 Colores Largos', 66883, 5, 'lapices.webp', 'Los mejores lapices del mercado, Leonardo Da Vinci aclamaba por ellos', 15, 3, 1),
 (23, 'Cinta De Papel Enmascarar P/pintor', 8050, 50, 'cinta.webp', 'Ancho: 12/18/24/36/48 mm Largo de rollo: 50 Metros Espesor: 140 Micrones Cinta de uso profesional, excelente adhesión a la mayoría de superficies. Viene en caja de 18, 24, 36, 48, 72 unidades. (Dependiendo la medida) Con un espesor de 140 micrones brinda máxima resistencia y efectividad. No daña la superficie que se adhiere.', 15, 3, 1),
 (24, 'Cuaderno Ecológico', 4999, 10, 'cuadernoVegetariano.webp', 'Cuaderno Ecológico/Reciclado Tamaño A5 liso tapa dura 1,5 mm forrado en papel kraft FSC Ecológico con 100 hojas interiores lisas en papel reciclado. Anillado doble ring wire color negro.', 15, 3, 1);
