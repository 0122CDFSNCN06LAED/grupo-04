...
const validations = [
    ...
    body('description').notEmpty().isLength({ min: 20 }).withMessage('agregue una descripcion'),
    body('description').isLength({ min: 20 }).withMessage('La descripcion debe ser superior a los 20 caracteres'),
